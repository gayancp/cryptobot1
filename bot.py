...
symbol = 'BTCUSDT'
intervals = ['1m','5m','15m', '1h', '2h', '6h']#720 144 48 12 6 2
...
def calculate_technical_indicators():
    ...
    try:    
        for index, row in df.iterrows():
            ...
            # Calculate SMA
            sma_value = calculate_sma(df, interval, timestamp, period)
...
for i in range(96):
    while True:        
        ...
        start_time += pd.Timedelta(seconds=40)
        end_time += pd.Timedelta(seconds=40)
